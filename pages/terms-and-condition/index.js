...
export default function TermsCondition() {
  return (
    <>
     <Head>
                <title>Terms and Condition || Stackkaroo</title>
            </Head>
      <Layout>
        <div>
            ...
            <div className="page-header__content">
              <div className="row justify-center text-center">
                <div className="col-lg-9 col-md-10">
                  <div>
                    <h1 className="page-header__title portfolio-heading lh-14">
                ...
                <div className="col-xl-4 col-lg-9 col-md-10">
                  <div className="px-20">
                    <p className="page-header__text">Welcome to Stackkaroo!</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="layout-pt-sm layout-pb-sm">
            <div className="container">
              <p>
                ...
                the use of Dailymyshopping Online Service Private Limited's
                Website, located at http://stackkaroo.com/.
              </p>
              <br />
              <p>
                By accessing this website, we assume you accept these terms and
                conditions. Do not continue to use Stackkaroo if you do not
              ...
              <p>
                ...
                experience. By accessing Stackkaroo, you agreed to use the
                required cookies.
              </p>
              <br />
              <p>
              ...
              <p>
                License: <br />
                Unless otherwise stated, Dailymyshopping Online Service Private
                Limited and/or its licensors own the intellectual property
                rights for all material on Stackkaroo. All intellectual property
                rights are reserved. You may access this from Stackkaroo for
              ...
              <p>
                You must not:
                <br />
                Copy or republish material from Stackkaroo <br />
                Sell, rent, or sub-license material from Stackkaroo <br />
                Reproduce, duplicate or copy material from Stackkaroo <br />
                Redistribute content from Stackkaroo
              </p>
              <br />
              <p>
                ...
                website. Dailymyshopping Online Service Private Limited does not
                filter, edit, publish or review Comments before their presence
                on the website. Comments do not reflect the views and opinions
                of Dailymyshopping Online Service Private Limited, its agents,
                and/or affiliates. Comments reflect the views and opinions of
                the person who posts their views and opinions. To the extent
                permitted by applicable laws, Dailymyshopping Online Service
                Private Limited shall not be liable for the Comments or any
              ...
              <br />
              <p>
              Dailymyshopping Online Service Private Limited reserves the right to monitor all Comments and remove any Comments that can be considered inappropriate, offensive, or causes breach of these Terms and Conditions.
...
The Comments do not invade any intellectual property right, including without limitation copyright, patent, or trademark of any third party;
              ...
              You hereby grant Dailymyshopping Online Service Private Limited a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats, or media.
              </p>
              <br />
              <p>
...
We will approve link requests from these organizations if we decide that: (a) the link would not make us look unfavorably to ourselves or to our accredited businesses; (b) the organization does not have any negative records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Dailymyshopping Online Service Private Limited; and (d) the link is in the context of general resource information.
...
<br />
If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you must inform us by sending an e-mail to Dailymyshopping Online Service Private Limited. Please include your name, your organization name, contact information as well as the URL of your site, a list of any URLs from which you intend to link to our Website, and a list of the URLs on our site to which you would like to link. Wait 2-3 weeks for a response.
            </p>
            <br />
            <p>
...
No use of Dailymyshopping Online Service Private Limited's logo or other artwork will be allowed for linking absent a trademark license agreement.
