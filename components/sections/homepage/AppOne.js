...
export default function AppOne() {
    return (
        <>
            <section className="layout-pt-md layout-pb-BG home-1-slider section-bg-color">
                <div className="section-bg-color__item -wide app-bgOrange bg-dark-1" />
                <div className="container">
                    <div className="row justify-center text-center">
                        <div className="col-auto">
                            <div className="sectionHeading -light">
                                <div className="sectionHeading__subtitle">
                                    <span className="bg-span-orange">EXPLORE NEW PRODUCTS</span>
                                </div>
                                <h2 className="sectionHeading__title">Our Products</h2>
                            </div>
                        </div>
                    </div>
                    <div
